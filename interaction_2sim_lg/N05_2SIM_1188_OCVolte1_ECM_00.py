...
@author: jingjing.nan
ScriptName:SLAB_N05_Interaction_2SIM_1188_OpenCloseVolte1_ExchangeMainCard_00
...
def OCV_EMC():
    ...
    for i in range(1, int(testTimes) + 1):
        ...
        time.sleep(30)
        openvlote = OpenVolte(0)
        time.sleep(30)
        MainCard = callObject.setMainCard(droid, 1)
        time.sleep(10)
        if closevolte & openvlote & MainCard:
            passTimes += 1
        else:
            failTimes += 1
