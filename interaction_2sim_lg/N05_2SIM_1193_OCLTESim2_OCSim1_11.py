...
@author: jingjing.nan
ScriptName:SLAB_N05_Interaction_2SIM_1193_OpenCloseLTESim2_OpenCloseSim1_11
Function:  sim2 maincard and datacard
'''
import android
...
def OpenCloseData_openClose():
    ...
    for i in range(1, int(testTimes) + 1):
        ...
        openSim = OpenSim(0)
        time.sleep(40)
        if closelte & openlte & closeSim & openSim:
            passTimes += 1
        else:
            failTimes += 1
