...
@author: PANPAN.WEI
ScriptName:SLAB_N05_Interaction_2SIM_1107_OpenCloseSim2_Sim1OpenCloseData_11_IMS.py
...
def OpenCloseSim1_OpenCloseSim2():
    ...
    for i in range(1, int(testTimes) + 1):
        ...
        passFlag3 = OpenSim(1)                                                              
        time.sleep(40)
        droid.log("=-------closesim(1)--=" + str(passFlag) + "---------opensim(1)-=" + str(passFlag3) + "-------closedate(0)-=" + str(passFlag1) + "------opendata(0)--" + str(passFlag2))
