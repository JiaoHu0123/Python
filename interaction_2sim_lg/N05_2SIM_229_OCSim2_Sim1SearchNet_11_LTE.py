...
@author: songchao.chu
ScriptName:SLAB_N05_Interaction_2SIM_DS_229_OpenCloseSim_Sim1SearchNet_11_LTE.py
...
def OpenCloseSIM_SearchNet():
    ...
    for i in range(1,int(testTimes)+1):
        ...
        time.sleep(10)
        droid.log("===CloseSim(1)="+str(passFlag1)+"===OpenSim(1)="+str(passFlag2)+"===searchingNet(1)="+str(passFlag3))
