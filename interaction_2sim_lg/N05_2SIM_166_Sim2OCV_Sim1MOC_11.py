...
commObject.summary(droid, "INTERACTION", "MULTI", simtype, "Voice Call", "L+G", "120", SIM1Status, SIM2Status, Network1Status, Network2Status)
...
if droid.sendCommand("IsPluginSimCard 0", "OK") and droid.sendCommand("IsPluginSimCard 1", "OK"):
    ...
    callObject.setCallSim(droid, 0)  # SIM1 CALL
    OC_MOC(callnum)
