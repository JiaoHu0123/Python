...
@author: songchao.chu
ScriptName:SLAB_N05_Interaction_2SIM_DS_411_Sim1OpenCloseData_Sim2MOC_00_IMS.py
Function:  MainCard:SIM1&DataCard:SIM1
           Sim1OpenCloseData and Sim2MOC (IMS)
'''
import android
...
#         passFlag4= callObject.voiceCall(droid, callNumber, hold_time)
        time.sleep(10)
        droid.log("===CloseData(1)="+str(passFlag1)+"===OpenData(1)="+str(passFlag2)+"===moc(2)="+str(passFlag3))
