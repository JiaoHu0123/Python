...
@author: songchao.chu
ScriptName:SLAB_N05_Interaction_2SIM_DS_437_Sim2OpenCloseData_Sim1 SMS_11_IMS.py
Function:  MainCard:SIM2&DataCard:SIM2
           Sim2 OpenCloseData and Sim1 SMS (IMS)
'''
import android
...
#         passFlag4= callObject.voiceCall(droid, callNumber, hold_time)
        time.sleep(10)
        droid.log("===CloseData(2)="+str(passFlag1)+"===OpenData(2)="+str(passFlag2)+"===sms(1)="+str(smsFlag))
