...
@author: jingjing.nan
ScriptName:
Function:  sim1 is main card and data card,close sim1 volte,sim2 sms,open sim1
'''
import android
...
#===========================================================================================================  
def SMS():
    flagSetSMSCard = smsObject.setSMSSim(droid, 1)
    time.sleep(20)
    Sms_Num = smsObject.getSmsNumber(droid, 1)
    droid.log(Sms_Num)
