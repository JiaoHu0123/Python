...
@author: panpan.wei
ScriptName:SLAB_N05_Interaction_2SIM_1136_Modechange_OpenCloseviceSim_11(IMS)
Function: 1. Close Vice Sim1,Open Vice card SIM1,the main card data card still Sim2
2. Sim2 modechange,Set to default settings
3. loop step1-2
'''
import android
