...
@author: songchao.chu
ScriptName:SLAB_N05_Interaction_2SIM_DS_277_OpenCloseSim1_Sim2MOC_11_IMS.py
Function:  MainCard:SIM2&DataCard:SIM2
           OpenCloseSim1 and Sim2MOC(IMS)
'''
import android
...
#         passFlag4= callObject.voiceCall(droid, callNumber, hold_time)
        time.sleep(10)
        droid.log("===CloseSim(0)="+str(passFlag1)+"===OpenSim(0)="+str(passFlag2)+"===moc(2)="+str(passFlag3))
