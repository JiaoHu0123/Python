...
@author: panbin.ai
CaseName:SLAB_N05_Interaction_DS_689_Sim2ExchangeDataCard_Sim1SelNet_IMS_11
Fuction:sim2 maincard sim2 datacard Sim1ExchangeDataCard_Sim2SelNet IMS network
'''
import android
...
if droid.sendCommand("IsPluginSimCard 0", "OK") and droid.sendCommand("IsPluginSimCard 1", "OK"):
    ...
    if SelLTE(sim) and CheckIMS(sim):
        ExchangeDataCard_SelNet(simtype, 0)
    else:
