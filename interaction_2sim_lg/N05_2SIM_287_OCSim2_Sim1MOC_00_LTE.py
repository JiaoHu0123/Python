...
@author: songchao.chu
ScriptName:SLAB_N05_Interaction_2SIM_DS_287_OpenCloseSim2_Sim1MOC_10_LTE.py
Function:  MainCard:SIM1&DataCard:SIM1
           OpenCloseSim2 and Sim1MOC(LTE)
'''
import android
...
#         passFlag4= callObject.voiceCall(droid, callNumber, hold_time)
        time.sleep(10)
        droid.log("===CloseSim(1)=" + str(passFlag1) + "===OpenSim(1)=" + str(passFlag2) + "===moc(1)=" + str(passFlag3))
