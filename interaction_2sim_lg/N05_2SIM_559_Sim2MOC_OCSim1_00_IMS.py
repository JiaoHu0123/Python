...
@author: molly
ScriptName:SLAB_N05_Interaction_2SIM_559_Sim2 MOC and OpenCloseSim1_00_IMS.py
Function:  MainCard:SIM1&DataCard:SIM1
           Sim2 MOC and OpenCloseSim1(IMS)
'''
import android
...
simtype = callObject.getSimType(droid, sim)
callNumber = callObject.getCardType(droid, 1)
