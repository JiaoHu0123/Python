...
@author: jingjing.nan
ScriptName:SLAB_N05_Interaction_2SIM_1132_OpenCloseViceCard_OpenCloseLTE_11
Function:  sim2 is main card and data card
           1. Close Vice Sim1,Open Vice card SIM1,the main card data card still Sim2
            2. Close Sim2 LTE,Open LTE,Set to default 
'''
import android
